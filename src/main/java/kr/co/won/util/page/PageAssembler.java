...
public class PageAssembler<T> implements RepresentationModelAssembler<Page<T>, PagedModel<EntityModel<T>>> {
    @Override
...
/*
    ...
    *//**
     ...
     *//*
    public PageAssembler(@Nullable HateoasPageableHandlerMethodArgumentResolver resolver,
    ...
    *//**
    ...
    private PagedModel<?> toEmptyModel(Page<?> page, Class<?> type, Optional<Link> link) {
        ...
        return addPaginationLinks(of(embedded, metadata), page, link);
    }
    ...
    *//**
    ...
    private PageMetadata asPageMetadata(Page<?> page) {
        ...
        int number = false ? page.getNumber() + 1 : page.getNumber();
    ...
    private String baseUriOrCurrentRequest() {
        return baseUri.map(Object::toString).orElseGet(PageAssembler::currentRequest);
    }
